...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        ...
        // Dummy
        listMhs.add(new Mahasiswa("2132888", "Jeon Jungkook", "A", "SBMPTN"));
        listMhs.add(new Mahasiswa("2001103", "Kim Taehyung", "B", "SNMPTN"));
        listMhs.add(new Mahasiswa("2202222", "Park Jimin", "C", "Mandiri"));
    ...
    public final DefaultTableModel setTable() {
        // Column Title
        Object[] column = {"NIM", "Nama", "Nilai", "Jalur Seleksi"};
        ...
        for (int i = 0; i < listMhs.size(); i++)
        {
            ...
            row[3] = listMhs.get(i).getJalurSeleksi();
    ...
    public void insertData() {
        ...
        String jalurSeleksi = null;
        if(rbSNMPTN.isSelected()) {
            jalurSeleksi = rbSNMPTN.getText();
        } else if (rbSBMPTN.isSelected()) {
            jalurSeleksi = rbSBMPTN.getText();
        } else {
            jalurSeleksi = rbMandiri.getText();
        }
        
        // Add New Data
        listMhs.add(new Mahasiswa(nim, nama, nilai, jalurSeleksi));
    ...
    public void updateData() {
        ...
        listMhs.get(selectedID).setJalurSeleksi(jalurSeleksi);
    ...
    public void deleteData() {
        // Alert Notification
        int del = JOptionPane.showConfirmDialog(null,"Apakah yakin ingin menghapus data ini?", "Konfirmasi", JOptionPane.YES_NO_OPTION);
    ...
    public void resetForm() {
        ...
        fieldNama.setText("");
        fieldNilai.setText("");
        buttonGroupSeleksi.clearSelection();
    }
    ...
    private void initComponents() {
        ...
        buttonGroupSeleksi = new javax.swing.ButtonGroup();
        ...
        lblJalurSeleksi = new javax.swing.JLabel();
        ...
        lblJalurSeleksi.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        lblJalurSeleksi.setForeground(new java.awt.Color(255, 255, 255));
        lblJalurSeleksi.setText("Jalur Seleksi");

        buttonGroupSeleksi.add(rbSNMPTN);
        rbSNMPTN.setForeground(new java.awt.Color(255, 255, 255));
        ...
        buttonGroupSeleksi.add(rbSBMPTN);
        rbSBMPTN.setForeground(new java.awt.Color(255, 255, 255));
        ...
        buttonGroupSeleksi.add(rbMandiri);
        rbMandiri.setForeground(new java.awt.Color(255, 255, 255));
        rbMandiri.setText("Mandiri");
        rbMandiri.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rbMandiriActionPerformed(evt);
            }
        });
...
//        
//        // Radio Button biar tidak bisa milih lebih dari radio button
//        ButtonGroup buttonGroup = new ButtonGroup();
//        buttonGroup.add(rbSNMPTN);
//        buttonGroup.add(rbSBMPTN);
//        buttonGroup.add(rbMandiri);
//    }
    ...
    private void tblMhsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMhsMouseClicked
        ...
        String selectedJalurSeleksi = (tblMhs.getModel().getValueAt(row, 3).toString());
        ...
        if (selectedJalurSeleksi.equals("SNMPTN")){
            rbSNMPTN.setSelected(true);
        } else if (selectedJalurSeleksi.equals("SBMPTN")){
            rbSBMPTN.setSelected(true);
        } else{
    ...
    private void rbMandiriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbMandiriActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rbMandiriActionPerformed
